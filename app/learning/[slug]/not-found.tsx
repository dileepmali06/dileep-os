        ...
        <div className="mx-auto max-w-2xl overflow-hidden rounded-2xl border-[3px] border-black bg-white shadow-[8px_8px_0px_#000]">
          <div className="flex items-center gap-3.5 border-b-[3px] border-black bg-[var(--yellow)] px-6 py-4">
            ...
            <div>
              ...
              <h1 className="text-lg font-black">Entry not found</h1>
            </div>
          </div>

          <div className="p-6 sm:p-8">
            <p className="text-sm leading-relaxed text-neutral-600">
              The learning log entry you&apos;re looking for doesn&apos;t
            ...
            <div className="mt-5 rounded-lg border-[2px] border-black bg-neutral-950 p-4">
              <p className="font-mono text-xs leading-relaxed text-[var(--yellow)]">
                EntryNotFoundException: LearningLog
              </p>
              <div className="mt-2 space-y-1 font-mono text-[11px] leading-relaxed text-neutral-500">
                <p>at learning.log.Registry.lookup(Registry.java)</p>
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/learning"
                className="inline-flex flex-1 items-center justify-center gap-2 rounded-xl border-[2px] border-black bg-[var(--blue)] px-6 py-3 font-black shadow-[4px_4px_0px_#000] transition-all hover:-translate-y-0.5"
              >
                <ArrowLeft size={16} />
                Back to log
              </Link>
