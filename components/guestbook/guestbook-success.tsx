...
type GuestbookSuccessProps = {
  onReset: () => void;
};

export default function GuestbookSuccess({ onReset }: GuestbookSuccessProps) {
  return (
    <div className="flex flex-col items-center rounded-2xl border-[3px] border-black bg-[var(--green)] p-10 text-center shadow-[7px_7px_0px_#000]">
      ...
      <p className="mx-auto mt-2 max-w-sm text-sm leading-relaxed text-black/70">
        Thanks for stopping by. Your message is pending a quick review and
        will show up here once approved.
      </p>
      <button
        onClick={onReset}
