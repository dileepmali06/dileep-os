...
export function ProjectChallenges({ project }: Props) {
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8 space-y-3">
            {project.challenges.map((item: string, index: number) => (
              ...
              >
                <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full border-[2px] border-black bg-[var(--pink)] text-xs font-bold">
